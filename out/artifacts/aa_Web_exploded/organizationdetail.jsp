...
<div>
    <div style="margin-top:10px;padding-top: 25px;margin-bottom:30px;line-height: 30px;background-color: #F3BE9C;">
        <p style="text-align: center;font-size:24px;font-weight: 900;padding-bottom: 25px;color:black;letter-spacing: 3px;">古美敬老院</p>
    </div>
    <div class="contt">
    <ul class="form-group">
